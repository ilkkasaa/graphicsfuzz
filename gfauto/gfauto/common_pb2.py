...
_BINARY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="platform",
            full_name="gfauto.Binary.platform",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_ARCHIVE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="output_file",
            full_name="gfauto.Archive.output_file",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gfauto.Archive.output_directory",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_ARCHIVESET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="archives",
            full_name="gfauto.ArchiveSet.archives",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="binaries",
            full_name="gfauto.ArchiveSet.binaries",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
ArchiveSet = _reflection.GeneratedProtocolMessageType(
    "ArchiveSet",
    (_message.Message,),
    dict(
