...
class Device(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"android",u"device",u"host",u"name",u"preprocess",u"swift_shader"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"android",b"device",b"host",b"name",b"preprocess",b"swift_shader"]) -> None: ...
...
class DeviceSwiftShader(google___protobuf___message___Message):
    version_hash = ... # type: typing___Text

    def __init__(self,
        version_hash : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"version_hash"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"version_hash"]) -> None: ...
