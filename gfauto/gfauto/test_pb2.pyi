...
class Test(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"crash_signature",u"device",u"glsl",u"test"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"device",b"device",u"glsl",b"glsl",u"test",b"test"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"crash_signature",b"device",b"glsl",b"test"]) -> None: ...
