...
class Settings(google___protobuf___message___Message):
    ...
    @property
    def default_binaries(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[gfauto___common_pb2___Binary]: ...

    def __init__(self,
        device_list : typing___Optional[gfauto___device_pb2___DeviceList] = None,
        default_binaries : typing___Optional[typing___Iterable[gfauto___common_pb2___Binary]] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"default_binaries",u"device_list"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"device_list",b"device_list"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"default_binaries",b"device_list"]) -> None: ...
