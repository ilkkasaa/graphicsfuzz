...
class Recipe(google___protobuf___message___Message):
    ...
    @property
    def glsl_shader_job_to_spirv_shader_job(
        self
    ) -> RecipeGlslShaderJobToSpirvShaderJob: ...
    @property
    def spirv_shader_job_to_spirv_shader_job_opt(
        self
    ...
    @property
    def spirv_shader_job_to_spirv_asm_shader_job(
        self
    ) -> RecipeSpirvShaderJobToSpirvAsmShaderJob: ...
    def __init__(
        self,
        command: typing___Optional[RecipeCommand] = None,
        glsl_shader_job_to_spirv_shader_job: typing___Optional[
            RecipeGlslShaderJobToSpirvShaderJob
        ] = None,
        spirv_shader_job_to_spirv_shader_job_opt: typing___Optional[
            RecipeSpirvShaderJobToSpirvShaderJobOpt
        ] = None,
        glsl_shader_job_add_red_pixels: typing___Optional[
            RecipeGlslShaderJobAddRedPixels
        ] = None,
        spirv_asm_shader_job_to_amber_script: typing___Optional[
            RecipeSpirvAsmShaderJobToAmberScript
        ] = None,
        spirv_shader_job_to_spirv_asm_shader_job: typing___Optional[
            RecipeSpirvShaderJobToSpirvAsmShaderJob
        ] = None,
    ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def HasField(
            ...
            field_name: typing_extensions___Literal[
                ...
                u"glsl_shader_job_to_spirv_shader_job",
                u"recipe",
                u"spirv_asm_shader_job_to_amber_script",
                u"spirv_shader_job_to_spirv_asm_shader_job",
                u"spirv_shader_job_to_spirv_shader_job_opt",
            ],
        ) -> bool: ...
        def ClearField(
            self,
        ...
        def HasField(
            ...
            field_name: typing_extensions___Literal[
                ...
                b"recipe",
                u"spirv_asm_shader_job_to_amber_script",
                b"spirv_asm_shader_job_to_amber_script",
                u"spirv_shader_job_to_spirv_asm_shader_job",
                b"spirv_shader_job_to_spirv_asm_shader_job",
                u"spirv_shader_job_to_spirv_shader_job_opt",
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions___Literal[u"recipe", b"recipe"]
...
class RecipeCommand(google___protobuf___message___Message):
    ...
    def __init__(
        self, command: typing___Optional[typing___Iterable[typing___Text]] = None
    ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"command"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"command"]
        ) -> None: ...
...
class RecipeGlslShaderJobToSpirvShaderJob(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                u"glsl_shader_job_artifact", u"glslang_validator_artifact"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"glsl_shader_job_artifact", b"glslang_validator_artifact"
            ],
        ) -> None: ...
...
class RecipeSpirvShaderJobToSpirvShaderJobOpt(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                u"spirv_opt_args", u"spirv_opt_artifact", u"spirv_shader_job_artifact"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"spirv_opt_args", b"spirv_opt_artifact", b"spirv_shader_job_artifact"
            ],
        ) -> None: ...
...
class RecipeGlslShaderJobAddRedPixels(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                u"glsl_shader_job_artifact", u"graphics_fuzz_artifact"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"glsl_shader_job_artifact", b"graphics_fuzz_artifact"
            ],
        ) -> None: ...
...
class RecipeSpirvShaderJobToSpirvAsmShaderJob(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                u"spirv_dis_artifact", u"spirv_shader_job_artifact"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"spirv_dis_artifact", b"spirv_shader_job_artifact"
            ],
        ) -> None: ...
    ...
    if sys.version_info >= (3,):
        def ClearField(
            ...
            field_name: typing_extensions___Literal[
                ...
                u"add_glsl_source_as_comment",
                u"add_graphics_fuzz_comment",
                u"amber_script_output_file",
                u"comment_text_artifact",
                u"copyright_header_text_artifact",
                u"make_self_contained_test",
                u"spirv_asm_shader_job_artifact",
                u"use_default_fence_timeout",
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"add_generated_comment",
                b"add_glsl_source_as_comment",
                b"add_graphics_fuzz_comment",
                b"amber_script_output_file",
                b"comment_text_artifact",
                b"copyright_header_text_artifact",
                b"make_self_contained_test",
                b"spirv_asm_shader_job_artifact",
                b"use_default_fence_timeout",
            ],
        ) -> None: ...
