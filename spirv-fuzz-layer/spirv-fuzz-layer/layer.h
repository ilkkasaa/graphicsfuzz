...
class SpirvFuzzLayer : public layer_factory {
public:
	// Constructor for state_tracker
	SpirvFuzzLayer() : number_mem_objects_(0), total_memory_(0), present_count_(0) {};
	...
	VkResult PreCallCreateShaderModule(VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkShaderModule* pShaderModule);
